...
│   └── docker-compose.yml
├── tests/
│   ├── unit/                # 104 быстрых юнит-теста
│   ├── integration/         # 22 интеграционных теста (медленные, с ML-моделями)
...
**Покрытие:** 174 теста (114 быстрых + 60 медленных), включая 16 приёмочных
